  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('create_daily_payment')}}">
                    <i class="fas fa-plus"></i> Add Daily Payment
                </a>            
            </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Daily Payment List</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
